  ...
  return (
    <div className="narrow fade" style={{ padding: '40px 24px 0' }}>
      ...
      <div style={{ marginTop: 16 }}>
        {allRead && <div className="fade" style={{ marginBottom: 12 }}><Note tone="ok" icon={Icon.check()}><b>{t('Tutorial complete.', 'ट्यूटोरियल पूर्ण।', 'ट्यूटोरियल पूर्ण.')}</b> {t('Recorded against your application, so nobody can ask you to watch it again.', 'आपके आवेदन के साथ दर्ज किया गया, इसलिए कोई आपसे इसे फिर देखने को नहीं कह सकता।', 'तुमच्या अर्जासोबत नोंदवले, त्यामुळे कोणीही तुम्हाला ते पुन्हा पाहण्यास सांगू शकत नाही.')}</Note></div>}
        <Note tone={isAadhaar ? 'brand' : undefined}>{isAadhaar
          ? <span><b>{t('Your test password will arrive by SMS', 'आपका टेस्ट पासवर्ड SMS से आएगा', 'तुमचा टेस्ट पासवर्ड SMS ने येईल')}</b> {t('to the mobile registered against your Aadhaar. You can take the ten-question test from home, and download the licence the moment you pass.', 'आपके आधार से जुड़े मोबाइल पर। आप दस सवालों वाला टेस्ट घर से दे सकते हैं, और पास होने पर तुरंत लाइसेंस डाउनलोड कर सकते हैं।', 'तुमच्या आधारशी जोडलेल्या मोबाइलवर. तुम्ही दहा प्रश्नांची टेस्ट घरून देऊ शकता, आणि उत्तीर्ण झाल्यावर लगेच लायसन्स डाउनलोड करू शकता.')}</span>
