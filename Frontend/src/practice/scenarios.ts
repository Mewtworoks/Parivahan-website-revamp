...
export const SCENARIOS: PracticeScenario[] = [
  { id: 'S1', lvl: 'signals', vehicle: 'any', map: T_JUNC, art: [['signal', 12, 4, null, '#d9a12b'], ['car', 9, 8, '#3f7ec9'], ['ped', 15, 6, '#c8452f']],
  ...
  { id: 'S2', lvl: 'signals', vehicle: 'any', map: T_JUNC, art: [['car', 9, 8, '#3f7ec9'], ['car', 13, 6, '#d8d2c4']],
  ...
  { id: 'S3', lvl: 'signals', vehicle: 'any', map: T_JUNC, art: [['signal', 12, 4, null, '#d9a12b'], ['car', 9, 7, '#3f7ec9']],
  ...
  { id: 'S4', lvl: 'signals', vehicle: 'any', map: T_ZEBRA, art: [['car', 6, 4, '#3f7ec9'], ['ped', 13, 5, '#2f6b4f']],
  ...
  { id: 'H1', lvl: 'hazards', vehicle: 'car', map: T_ROAD, art: [['van', 7, 3, '#8c8f96'], ['car', 3, 6, '#3f7ec9'], ['child', 8, 5, '#c8452f']],
  ...
  { id: 'H2', lvl: 'hazards', vehicle: 'car', map: T_ROAD, art: [['cow', 11, 4], ['car', 4, 6, '#3f7ec9']],
  ...
  { id: 'H3', lvl: 'hazards', vehicle: 'car', map: T_ROAD, art: [['van', 13, 3, '#c5b46a'], ['car', 5, 6, '#3f7ec9'], ['ped', 12, 5, '#2f6b4f']],
  ...
  { id: 'H4', lvl: 'hazards', vehicle: 'car', map: T_ZEBRA, art: [['car', 4, 4, '#3f7ec9'], ['bike', 11, 6, '#c8452f']],
  ...
  { id: 'G1', lvl: 'signs', vehicle: 'any', map: T_TEE, art: [['sign', 5, 7, null, '#c8452f'], ['car', 9, 10, '#3f7ec9']],
  ...
  { id: 'G2', lvl: 'signs', vehicle: 'any', map: T_TEE, art: [['signc', 14, 3, null, '#c8452f'], ['car', 9, 9, '#3f7ec9']],
  ...
  { id: 'G3', lvl: 'signs', vehicle: 'bike', map: T_ROAD, art: [['bike', 8, 6, '#3f7ec9']],
  ...
  { id: 'G4', lvl: 'signs', vehicle: 'any', map: T_ROAD, art: [['car', 6, 6, '#3f7ec9'], ['car', 12, 4, '#d8d2c4']],
  ...
  { id: 'S5', lvl: 'signals', vehicle: 'any', map: T_JUNC, art: [['signal', 12, 4, null, '#c8452f'], ['car', 9, 8, '#3f7ec9']],
  ...
  { id: 'S6', lvl: 'signals', vehicle: 'any', map: T_JUNC, art: [['signal', 12, 4, null, '#5c9a5c'], ['van', 8, 7, '#c5b46a'], ['car', 9, 10, '#3f7ec9']],
  ...
  { id: 'H5', lvl: 'hazards', vehicle: 'car', map: T_ROAD, art: [['car', 5, 6, '#3f7ec9'], ['child', 12, 4, '#c8452f'], ['sign', 15, 8, null, '#2f6fb0']],
  ...
  { id: 'H6', lvl: 'hazards', vehicle: 'car', map: T_ROAD, art: [['car', 4, 6, '#3f7ec9'], ['car', 10, 6, '#d8d2c4']],
  ...
  { id: 'G5', lvl: 'signs', vehicle: 'any', map: T_TEE, art: [['rect', 6, 7, null, '#2f6fb0'], ['car', 11, 10, '#3f7ec9']],
  ...
  { id: 'G6', lvl: 'signs', vehicle: 'any', map: T_TEE, art: [['signc', 14, 3, null, '#2f6fb0'], ['car', 9, 9, '#3f7ec9']],
    ...
    cite: 'IRC:67 · mandatory signs' },
  { id: 'S7', lvl: 'signals', vehicle: 'any', map: T_JUNC, art: [['signal', 12, 4, null, '#5c9a5c'], ['car', 9, 8, '#3f7ec9']],
  ...
  { id: 'S8', lvl: 'signals', vehicle: 'any', map: T_JUNC, art: [['signal', 12, 4, null, '#c8452f'], ['car', 9, 8, '#3f7ec9'], ['car', 13, 10, '#d8d2c4']],
  ...
  { id: 'H7', lvl: 'hazards', vehicle: 'car', map: T_ROAD, art: [['car', 5, 6, '#3f7ec9'], ['bike', 8, 8, '#c8452f']],
  ...
  { id: 'H8', lvl: 'hazards', vehicle: 'car', map: T_ROAD, art: [['car', 4, 6, '#3f7ec9'], ['car', 13, 6, '#e8e3d8']],
  ...
  { id: 'G7', lvl: 'signs', vehicle: 'any', map: T_TEE, art: [['rect', 6, 7, null, '#2f6fb0'], ['car', 11, 10, '#3f7ec9']],
  ...
  { id: 'G8', lvl: 'signs', vehicle: 'any', map: T_TEE, art: [['sign', 5, 7, null, '#c8452f'], ['car', 9, 10, '#3f7ec9']],
  ...
  { id: 'G9', lvl: 'signs', vehicle: 'bike', map: T_ROAD, art: [['bike', 9, 6, '#3f7ec9']],
  ...
  { id: 'G10', lvl: 'signs', vehicle: 'bike', map: T_ROAD, art: [['bike', 9, 6, '#3f7ec9']],
  ...
  { id: 'G11', lvl: 'signs', vehicle: 'bike', map: T_ROAD, art: [['bike', 9, 6, '#3f7ec9']],
  ...
  { id: 'H9', lvl: 'hazards', vehicle: 'bike', map: T_ROAD, art: [['bike', 9, 6, '#3f7ec9'], ['car', 4, 6, '#d8d2c4'], ['van', 13, 3, '#8c8f96']],
  ...
  { id: 'H10', lvl: 'hazards', vehicle: 'bike', map: T_JUNC, art: [['bike', 9, 8, '#3f7ec9'], ['car', 13, 10, '#d8d2c4']],
