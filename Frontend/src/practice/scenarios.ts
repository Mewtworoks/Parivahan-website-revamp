...
export const SCENARIOS: PracticeScenario[] = [
  { id: 'S1', lvl: 'signals', vehicle: 'any', map: T_JUNC, art: [['signal', 12, 4, null, '#d9a12b'], ['car', 9, 7.5, '#3f7ec9'], ['ped', 15, 6, '#c8452f', undefined, undefined, 'cross']],
    q: 'You are 20 metres from the junction and the signal turns yellow. There is a pedestrian already on the far crossing.',
    a: ['Speed up and clear the junction before red', 'Stop before the line', 'Sound the horn and continue'], c: 1, axes: ['signal', 'hazard'],
    ex: 'Yellow means stop unless you are so close that stopping is unsafe. At 20 metres you can stop, and a pedestrian is already committed to the crossing.',
  ...
  { id: 'S3', lvl: 'signals', vehicle: 'any', map: T_JUNC, art: [['signal', 12, 4, null, '#d9a12b'], ['car', 9, 7.5, '#3f7ec9']],
    q: 'The signal is flashing yellow, not steady.',
    ...
    ex: 'A flashing yellow is a caution signal, not a stop signal. You may proceed once you have checked the junction is clear.',
  ...
  { id: 'S8', lvl: 'signals', vehicle: 'any', map: T_JUNC, art: [['signal', 12, 4, null, '#c8452f'], ['car', 9, 7.5, '#3f7ec9', undefined, 'h', false], ['car', 9.5, 10, '#d8d2c4', undefined, 'v']],
    q: 'You are first at a red light. You notice the signal for the cross-street traffic turn yellow, then red.',
